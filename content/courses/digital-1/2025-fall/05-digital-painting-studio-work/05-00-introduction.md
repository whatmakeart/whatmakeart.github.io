...
Students the review the feedback from their peers and draft a written plan of action for the project before commencing with idea refinement and studio work in class. In the second half of class, students present in progress work to the class for feedback and suggestions before completing the project for next class.

## Learning Objectives

- Clearly present ideas and sketch concepts to peers
- Actively listen to peers' feedback
- Give constructive criticism, feedback, and suggestions to peers based on their ideas
