...
[Photogrammetry](01-03-photogrammetry.md) is a useful tool for capturing 3D Geometry and visual texture information from the real physical world. [3D Scanning](01-01-3d-scanning.md) is able to capture more detail and more accurate geometry than photogrammetry, but requires more expensive 3D scanning equipment and software. [Gaussian Splatting](01-04-gaussian-splatting.md) is a method of using "splats" or gaussian "smears" to rebuild a 3D scene rather than a mesh.
...
- Process the photogrammetry data into a 3D mesh
