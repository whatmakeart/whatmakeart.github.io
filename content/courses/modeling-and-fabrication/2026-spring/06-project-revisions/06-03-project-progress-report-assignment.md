...
1. Brief written summary of current status of project
   - Label files YYYY-MM-DD Last Name First Name Project Progress Report (`.pdf`, `.docx`)
2. Photo and/or video documentation of project progress
   - Label files YYYY-MM-DD Last Name First Name Project Progress Documentation (`.png`,`.jpg`)
