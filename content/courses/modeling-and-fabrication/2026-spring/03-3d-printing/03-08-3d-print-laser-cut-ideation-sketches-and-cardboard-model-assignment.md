...
The goal of this project is to explore material hybridity. You will tackle specific design challenges using the 3D printing fabrication process in combination with [Laser Cutting](../../../../digital-fabrication/laser-cutting/laser-cutting.md). to design a lamp. You must solve the puzzle of how two disparate manufacturing processes, Additive 3D Printing and Subtractive Laser Cutting, can work together to create a functional object.
...
- [3D Printed Lamps](https://www.google.com/search?q=3d+printed+lamps&udm=2)
- [Laser Cut Lamps](https://www.google.com/search?q=laser+cut+lamps&udm=2)
- [e26 Lamp Socket Mounting](https://www.google.com/search?q=e26+lamp+socket+mounting&udm=2)
- [Laser Cut Light Diffusion Panels](https://www.google.com/search?q=laser+light+diffusion+panels&udm=2)
