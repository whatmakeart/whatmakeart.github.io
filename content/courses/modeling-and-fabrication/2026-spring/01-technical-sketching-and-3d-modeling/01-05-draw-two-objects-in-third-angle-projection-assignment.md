...
3. Using loose sheets of paper, _not_ in your sketchbooks, draw the two objects that you selected as third angle projections.

   - Draw one third angle projection freehand.
   - Draw one third angle projection with drawing tools.
...
9. Cleanly scan both sketches or use a photo. Submitted images should have flat lighting, no shadows, clean crop, and minimum of 1000s of pixels per side.
...
### 3. Object with Hole Third Angle Projection Freehand
...
### 4. Third Angle Projection USB Plug Freehand
...
### 5. Third Angle Projection with Drawing Tools
...
- Where would modeling break if dimensions are missing on the drawing?
