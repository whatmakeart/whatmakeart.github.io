...
Course Number: SEM 232

Department: Sculpture + Expanded Media

Room: Main Campus, Cleveland Institute of Art, 212H

Time: Fridays 9:30 pm - 11:45 am & 2:00 pm - 4:15 pm

Faculty: Jimmy Kuehnle - jkuehnle@cia.edu

Office Hours: Available by appointment. Please email your faculty to schedule a time to meet in person or online outside of class.

Semester: Fall 2026

[Canvas Course Page](https://cia.instructure.com/courses/2690)

[Course Website](https://whatmakeart.com/courses/fabrication-for-artists/2026-fall/)

## Course Description

Intro Sculpture Fabrication is a hands-on, studio-centered course focused on the broad set of fabrication skills needed by contemporary Sculpture + Expanded Media artists. Rather than centering only traditional wood/steel curricula, the course treats fabrication as an adaptable toolkit that spans welding and metalworking, woodworking, mechanical fastening, tapping threads, adhesives, rigging fundamentals, crimping braided cable, mold-making and rapid form-building (including papier-mâché and quick molds), and digital fabrication workflows including 3D printing, laser cutting, and CNC processes. Emphasis is placed on structural thinking, safe and repeatable workflows, material testing, and understanding how the evidence of making communicates meaning. Projects are designed to be portable into a wide range of student intentions including installation, objects, performance supports, interactive works, and hybrid media

## Course Goals and Learning Objectives

By the end of this course, students will the opportunity to:

- Gain significant exposure to a range of fundamental processes of fabrication.
- Understand the evidence of making as part of the language of artwork.
- Gain confidence in utilizing shop equipment and processes.
- Acquire a fundamental qualitative understanding of materiality.
- Develop an understanding of the relationship between fabrication and materiality as part of the exploratory process.
- Investigate materials as an aesthetic means of communication.
- Build an understanding of concepts/content and their relationship to structure and materiality.
...
| 5        | September 25     | [Bicycle Project Fabrication](../05-bicycle-project-fabrication/05-00-introduction.md)       |
| 6        | October 2        | [Bicycle Project Fabrication](../06-bicycle-project-fabrication/06-00-introduction.md)       |
| 7        | October 9        | [Bicycle Project Presentation](../07-bicycle-project-presentation/07-00-introduction.md)     |
...
- Course resources are available on [Canvas](https://cia.instructure.com/courses/2690) or [online](https://whatmakeart.com/courses/fabrication-for-artists/2026-fall/)
...
Projects and assignments must be submitted before the start of class on the due date. Late assignments will automatically incur a deduction of 1% per calendar day, up to a maximum penalty of 40%. No assignments will be accepted after the final day of class.
...
- We will use [Canvas to turn in assignments](https://cia.instructure.com/courses/2690).
- Use this format for naming all your class digital files:
  - YYYY-MM-DD Smith Lane Project 1
  - 2026-08-28 Smith Lane First Day Project 1
...
Students are expected to attend all class sessions, lectures, critiques, and required meetings. Artistic progress depends not only on completing assignments but also on active participation in studio and academic discussions. All class session absences count toward the semester absence total unless approved as an extenuating circumstance by the Dean of Students or in observation of a Religious Observance. Students are responsible for all missed materials, including assignments and tests; however, some activities, such as critiques, demonstrations, and collaborative projects may not be able to be replicated or made up. Faculty are required to take attendance at every class session and maintain accurate records. Institutionally mandated absence limits are as follows:

<div class="responsive-table-markdown">

| Course Type         | Days/Week | Sessions/Week + Attendance Tracking                                                        | Absence Limit \*                                                                       | Example                                                                                                                                                              |
| ------------------- | --------- | ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Studio Course       | 1         | 2 (Each day equals 2 class sessions) Attendance is tracked twice (once per class session). | No more than 6 class session absences per semester (20% of all class sessions).        | A course meets Tuesdays from 12-2 p.m. (1st session) and 2:30-5 p.m. (2nd session). Attendance is taken once during the 1st session and once during the 2nd session. |
| Studio Course       | 2         | 2 (Each day equals 1 class session) Attendance is tracked twice (once per class session).  | No more than 6 class session absences per semester (20% of all class sessions).        | A course meets Mondays and Wednesdays from 5:15-7:45 p.m. Attendance is taken once on Mondays and once on Wednesdays.                                                |
| Liberal Arts Course | 2         | 2 (Each day equals 1 class session) Attendance is tracked twice (once per class session).  | No more than 6 class session absences per semester (20% of all class sessions).        | A course meets Mondays and Wednesdays from 4:15-5:30 p.m. Attendance is taken once on Mondays and once on Wednesdays.                                                |
| Liberal Arts Course | 1         | 1 (Each day equals 1 class session) Attendance is tracked once (once per class session).   | No more than 3 class session absences per semester (20% of all class sessions).        | A course meets Mondays from 12-2:30 p.m. Attendance is taken once on Mondays.                                                                                        |
| Independent Study   | Varies    | Varies / Frequency of attendance tracking is at the discretion of the faculty member.      | Participation and attendance expectations are at the discretion of the faculty member. |                                                                                                                                                                      |

</div>

_\* Faculty may consider tardiness or early departures when determining a student’s attendance for a class session. Faculty are encouraged to include their policies on tardiness, early departure, and any related penalties in the course syllabus._
...
#### Absence Due to Religious Observances
