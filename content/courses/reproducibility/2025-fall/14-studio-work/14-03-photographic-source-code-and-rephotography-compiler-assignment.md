...
3.  Write a strict, algorithmic set of text instructions that would allow a stranger to reproduce this image _exactly_ as possible without ever seeing your photo.
    - Bad Instructions:
...
5. Repeat the process for each student's instructions.
...
- Miranda July an Harrell Fletcher [Learning to Love You More](http://www.learningtoloveyoumore.com/) - Online project of assignments such as "Repair something." or "Make a protest sign and protest." or "Spend time with a dying person."
