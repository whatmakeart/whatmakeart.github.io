...
Each student still turns in the project. The final video may be from the same source material but each student should make their own edit and final video export.

### Requirements

- Combine a minimum of 3 shots from the XR studio into a single video
...
| Assessment                   | Weight    |
| ---------------------------- | --------- |
| Exported mp4 Uploaded        | 20 points |
| Editing                      | 35 points |
| Sound Effects Added          | 35 points |
...
[How to Import Video Into Premiere Pro](https://youtu.be/kpsxbwX0Mps)

<div class="iframe-16-9-container">
<iframe class="youTubeIframe" width="560" height="315" src="https://www.youtube.com/embed/kpsxbwX0Mps?rel=0" title="Photogrammetry with Adobe Substance 3D Sampler" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
</div>
...
[Adobe Audition: Create a New Audio File, Set Sample Rate, and Save Properly](https://youtu.be/o70n1NHDz8s)

<div class="iframe-16-9-container">
<iframe class="youTubeIframe" width="560" height="315" src="https://www.youtube.com/embed/o70n1NHDz8s?rel=0" title="Photogrammetry with Adobe Substance 3D Sampler" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
</div>
