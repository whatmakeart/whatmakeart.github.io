...
[After Effects](./after-effects/after-effects.md) has more robust chroma keying tools than [Adobe Premiere](./adobe-premiere-pro/adobe-premiere.md).

- Transcoding compressed H.264 or H.265 source footage to ProRes or other quality [video codecs](./video-codecs.md) can help with the speed of work and rendering.
...
- [Background Light Wrap After Effects](./after-effects/background-light-wrap-after-effects.md)
- [Green Screen with Key Light After Effects](./after-effects/green-screen-key-with-keylight-in-after-effects.md)
- [Fix Bad Green Screen Footage](./after-effects/fix-bad-green-screen-footage.md)
