...
This [sewing](sewing.md) tutorial shows how to cut the pattern pieces for a tote bag with a lining and then how to sew them together.

## Prerequisites

To complete this tutorial you should know:

- [How to Thread an Juki DDL 870 Industrial Sewing Machine](how-to-thread-a-home-sewing-machine.md)
