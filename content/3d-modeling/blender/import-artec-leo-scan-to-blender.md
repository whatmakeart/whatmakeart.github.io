...
lastmod: 2026-03-17T07:17:08-04:00
tags:
  - 3D-Modeling
  - Blender
  - 3D-Scanning
...
[Import Artec LEO Scan into Blender](https://youtu.be/-8Tvn8UFG0Y)

The objective is to prepare the scan for further use in [Blender](blender.md) and [Autodesk Fusion](../fusion-360/fusion-360.md) for modeling and [3D printing](../../digital-fabrication/3d-printing/3d-printing.md).
