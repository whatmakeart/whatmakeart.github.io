...
9. After the cast is de-molded, the lip can be trimmed and slightly smoothed with a wet sponge. Be careful not to use too much water.
...
- If your the slip level in the pour reservoir drops, you can add a bit more slip to ensure even wall thickness. The reservoir will be cut off so this should not be a problem unless the reservoir is very small.
...
- If you have places in your mold that are prone to capturing air bubbles then first pour some slip in and tilt the mold to coat all surfaces. Then continue to add slip and occasionally tilt and rotate the mold to allow all trapped air to escape.
